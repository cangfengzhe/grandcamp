...
from bootcamp.report import views as report_views

urlpatterns = [
    url(r'^$', core_views.home, name='home'),
    # url(r'^$', report_views.report_form, name='home'),
    ...
    url(r'^social/', include('bootcamp.social.urls')),
    url(r'^report/', include('bootcamp.report.urls')),
